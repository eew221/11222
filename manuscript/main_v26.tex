...
\textbf{Code availability.} The experiment and analysis scripts, manuscript source, blank human-audit templates, environment specification, and derived non-image manifests are available at \url{https://github.com/eew221/11222}. Before submission, the authors must create and cite a tagged immutable release of that repository and archive it with Zenodo (or an equivalent service); the resulting release identifier, commit hash, and DOI must be inserted here. This manuscript does not claim a DOI before that archival release exists.
