...
\textbf{Code availability.} The experiment and analysis scripts, manuscript source, blank human-audit templates, environment specification, and derived non-image manifests are publicly available under the MIT License at \url{https://github.com/eew221/11222}. The immutable GitHub release \texttt{v0.4.2} resolves to commit \texttt{6b916c59570ec5db1d068b00299ff8802b037846} and is archived as a versioned Zenodo record at \url{https://doi.org/10.5281/zenodo.22119278}. The release contains the source and aggregate materials used for this revision, including the random-audit diagnostics, the pre-frozen detector-output audit generator, the three-pass annotation service, and the post-freeze error-decomposition script. The repository and archive deliberately exclude original frames, image-derived overlays, weights, caches, and per-image labels.
