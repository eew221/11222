...
\textbf{Ethics and privacy.} The self-collected frames may contain identifiable people. Before submission, the authors will manually review and strongly redact faces, badges or names, vehicle plates, company marks, and other identifiable information in every qualitative crop; the redaction coordinates will be frozen before the final Figure~\ref{fig:qualitative} is rendered. The institutional authorization, approval, or documented exemption basis for research use and publication of the redacted crops must be confirmed by the data-owning organization before submission. No unredacted frame or redaction overlay is released in the public repository.
