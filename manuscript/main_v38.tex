...
\textbf{Code availability.} The experiment and analysis scripts, v38 manuscript source, blank human-audit templates, environment specification, and derived non-image manifests are publicly available under the MIT License at \url{https://github.com/eew221/11222}. The v38 package is frozen in GitHub release \texttt{v0.4.3}, which resolves to commit \texttt{0d32f36361a01b8d4c2a456ac6c4858bcbb4d4fb} and is archived as a versioned Zenodo record at \url{https://doi.org/10.5281/zenodo.22141331}. The prior \texttt{v0.4.2} record (DOI \url{https://doi.org/10.5281/zenodo.22119278}) predates v38 and is not cited as the archive for this manuscript. The repository and archive deliberately exclude original frames, image-derived overlays, weights, caches, and per-image labels.
