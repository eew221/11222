...
- v38 archival status: finalized in GitHub release `v0.4.4`; its immutable tag identifies the archived commit. The Zenodo concept DOI is `10.5281/zenodo.22141330`, and the `v0.4.4` release page records the matching version-specific DOI.
