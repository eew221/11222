...
- Source: `manuscript/main_v37.tex`
- Bibliography: `manuscript/references.bib`
- Local compiled PDF: `RC_WSSI_MVA_manuscript_v37.pdf` in the author workspace
- Local PDF page count: 25 pages. The compiled PDF is not public because qualitative source images remain restricted.
- Local PDF SHA-256: `81B21D267689581AFE8AADF3444FC9006DDE8DC154343BC5C0A3C5EFDB250BFD`.
...
The public files are in `audit/independent_worker_state_random_20260827_v1/results_v37_public/`. The public package excludes the consensus CSV, annotator responses, annotated images, and the per-row method output because those materials are image-derived or row-level restricted records.
