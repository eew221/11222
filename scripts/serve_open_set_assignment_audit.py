...
class Store:
    ...
    def bootstrap(self) -> dict:
        ...
        return {"annotator": self.annotator, "locked": self.locked(), "rows": rows,
                "images": [{"audit_id": aid, "image": self.images[aid], "source_group": self.manifest[aid]["source_group"], "fold": self.manifest[aid]["fold"], "evidence_count": self.manifest[aid]["evidence_count"]} for aid in order],
