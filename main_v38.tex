...
\textbf{Code availability.} The experiment and analysis scripts, v38 manuscript source, blank human-audit templates, environment specification, and derived non-image manifests are publicly available under the MIT License at \url{https://github.com/eew221/11222}. The final v38 package is frozen in GitHub release \texttt{v0.4.6}; its immutable tag identifies the archived repository commit. The release family is permanently archived under the Zenodo concept DOI \url{https://doi.org/10.5281/zenodo.22119277}, whose version record identifies \texttt{v0.4.6}. The repository and archive deliberately exclude original frames, image-derived overlays, weights, caches, and per-image labels.

\textbf{Ethics and privacy.} The dataset consists of self-collected low-light tunnel PPE frames held privately by the authors; no third-party dataset or public-data license is claimed. The raw frames may contain identifiable people and are not released. Each qualitative source crop used in Figure~\ref{fig:qualitative} was manually reviewed, and faces, badges or names, vehicle plates, company marks, and other identifying features were strongly pixelated where present. The four-panel redaction manifest was frozen before final rendering; neither unredacted frames nor redaction overlays are released in the public repository. This manuscript reports no institutional approval identifier or data-owner authorization identifier for the privately collected dataset and therefore makes no claim of an approval or exemption that is not documented. Any editorial request for restricted access would require a separate privacy and data-owner review and is not a promise of public or unrestricted release.
